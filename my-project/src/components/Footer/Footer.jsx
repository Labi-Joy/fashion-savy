  ...
  return (
   <div>  
       <div className='lg:flex '>
         <div className='lg:grid lg:items-center lg:justify-between md:'>
             <div className='lg:py-16 md:w-full md:h-full md:items-center md:justify-center md:flex md:flex-col '><img className=' flex justify-center items-center  px-40 p-1' src= {Logo} alt="" /></div>
        ...
        <div className='lg:flex lg:py-40 p-5 lg:justify-between lg:gap-10 md:flex md:justify-around md:gap-2'>
