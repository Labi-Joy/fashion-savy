...
export const Header = () => {
  return (
    < div className='p-5 text-primary-color cursor-pointer text-center w-[100%]'>
            <div className='flex gap-20'>
              {/* <p className='hidden lg:block lg:py-5'>FashionSavvy</p> */}
                 <img className='w-20 px-1 lg:ml-16' src={HeaderLogo} alt="" />

                        <nav className='hidden lg:block  lg:items-center lg:py-7 lg:ml-40'>
                        <ul className='hidden lg:flex lg:flex-row lg:gap-10 lg:font-semibold'>
