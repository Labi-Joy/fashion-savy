...
const CartProps = ({imageSrc, cartTitle, size, quantity, amount}) => {
  return (
    <div className='py-1 px-7 lg:px-12 '>
               ...
               <div className='lg:text-xl lg:mt-4'>
                 ...
                 <div className='lg:flex gap-4'>
                    ...
                    <div className='flex gap-2 py-2 lg:py-5 lg:gap-3'>
                      ...
                      <div className='flex border border-tetiary-color h-full p-1 px-2 rounded-lg lg:border-2 lg:px-4'><p className='text-xs lg:text-lg lg:font-semibold'>Wishlist</p><img src={Blackheart} alt="" className='px-1 w-5 lg:w-8 ' /></div>  
                    </div>
                 </div>
              </div>
...
export const MyCartHero = () => {
  return (
    <div className='bg-tetiary-color bg-opacity-10 lg:p-2'>
        <div className=''>
            <div className=' flex ml-[20px] text-xs gap-10 lg:gap-10 lg:mr-[600px] lg:font-semibold lg:text-lg lg:px-9'> 
  ...
  <div className='flex gap-5 '>
      <div className='flex flex-col  gap-5 mb-6 lg:gap-5 lg:mt-5'>
...
<div className='grid grid-cols-1 gap-10 lg:px-20'>
      <div className='hidden lg:block lg:bg-button-color lg:px-6 lg:py-4 lg:rounded-lg '>
        <form action="" className='h-20'>
          ...
          <button className='bg-tetiary-color hover:bg-opacity-30 py-2 px-4 rounded-md font-semibold'>Apply</button>
        </form>
      </div>
      ...
      <div className='hidden lg:block lg:mb-[250px] lg:py-2'>
          ...
          <div className='flex gap-14 py-5'>
            ...
            <p className='font-bold'>N236,000</p>
          </div>
          ...
          <div className='flex gap-14 '>
            ...
            <div className='flex flex-col  '>
              <p>Free shipping</p>
           <div className='flex  gap-16  py-4'><p>Shipping to Lagos</p> <p className='font-bold  '>Change</p></div>
            </div> 
         ...
         <div className='py-4 '><button className='bg-tetiary-color hover:bg-opacity-30 w-[400px] py-3 rounded-lg font-bold'>
          Checkout
         </button></div>
